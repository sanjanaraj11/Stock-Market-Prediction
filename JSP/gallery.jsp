...
.style7 {font-size: 18px; font-weight: bold; color: #000000; }
-->
</style>
</head>
<body>
<div align="center" class="style1 style6">All Company Details</div>
<p align="center">&nbsp;</p>
...
<table width="669" border="0" align="center">
  <tr>
    <td width="179"><div align="left" class="style7">Company Name </div></td>
    <td width="480"><%=s2%></td>
  </tr>
  <tr>
    <td><div align="left" class="style7">Sector</div></td>
    <td><%=s3%></td>
  </tr>
  <tr>
    <td><div align="left" class="style7">Company Details</div></td>
    <td><%=s4%></td>
  </tr>
  <tr>
    <td><div align="left" class="style7">Location</div></td>
    <td><%=s5%></td>
  </tr>
  <tr>
    <td><div align="left" class="style7">Address</div></td>
    <td><%=s6%></td>
  </tr>
  <tr>
    <td><div align="left" class="style7">Logo </div></td>
    <td><div align="center">
      <input required name="image" type="image" src="images.jsp?imgid=<%=i%>" width="100" height="100" alt="Submit">
    </div></td>
  </tr>
  <tr>
    <td><div align="left" class="style7">Ratings</div></td>
    <td><% 
    if(j==3)
    {
    	%>
