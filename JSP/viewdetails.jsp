...
<table width="669" border="0" align="center">
  <tr>
    <td width="179"><div align="left" class="style5">Company Name </div></td>
    <td width="480"><%=s2%></td>
  </tr>
  <tr>
    <td><div align="left" class="style5">Sector</div></td>
    <td><%=s3%></td>
  </tr>
  <tr>
    <td><div align="left" class="style5">Company Details </div></td>
    <td><%=s4%></td>
  </tr>
  <tr>
  ...
  <tr>
    <td><div align="left" class="style5">Logo </div></td>
    <td>
      <div align="left">
